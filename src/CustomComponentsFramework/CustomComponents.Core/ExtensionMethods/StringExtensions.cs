...
namespace CustomComponents.Core.ExtensionMethods
{
    ...
    public static class StringExtensions
    {
        ...
        public static String PlaceHolders(this String str, params object[] args)
        {
        ...
        /// <summary>
        ///     Truncate current string if string length is greater than numCharsToConsiderate, 
        ///     and optionally appends endWith characters at the end
        /// </summary>
        public static string Truncate(this string text, int numCharsToConsiderate, string endWith = "..")
        {
            if (text.Length <= numCharsToConsiderate)
                return text;

            return text.Substring(0, numCharsToConsiderate) + endWith;
        }
